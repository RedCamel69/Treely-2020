...
namespace Treely_2020.Controllers
{
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Index([FromRoute]int page = 0)
        {
            ...
            var url = rq.Scheme + "://" + rq.Host + "/blog";
            ...
            ViewData["prev"] = String.Empty;
            ViewData["next"] = String.Empty;
            ViewData["prev"] = $"{url}/{page + 1}/";
            ViewData["next"] = $"{url}/{(page <= 1 ? null : page - 1 + "/")}";
        ...
        public async Task<IActionResult> UpdatePost(Post post)
        {
            ...
            existing.Slug = !string.IsNullOrWhiteSpace(post.Slug) ? post.Slug.Trim() : Treely_2020.Models.Post.CreateSlug(post.Title);
